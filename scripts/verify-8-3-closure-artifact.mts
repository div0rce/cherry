...
const CLOSURE_SUITE = [
  ...
  'tests/next/api-scan.runtime-degradation.test.js',
  'tests/api-autopilot-preview.runtime-degradation.test.js',
  'tests/next/api-autopilot-preview.runtime-degradation.test.js',
  'tests/api-simulate.runtime-degradation.test.js',
  'tests/next/api-simulate.runtime-degradation.test.js',
