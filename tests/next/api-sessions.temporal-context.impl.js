...
async function run() {
  ...
  let currentState = buildState({ kind: 'unavailable' });
    ...
    prisma: {
      recommendationSession: {
        create: async () => ({
          ...
          expiresAt: new Date('2024-01-01T00:15:00Z').toISOString(),
          source: 'APP_SCAN',
        }),
      },
    },
