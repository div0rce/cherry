...
export default function Input({ className, hasError = false, ...rest }: InputProps): JSX.Element {
  return (
    <input
      className={cn(
        'w-full rounded-md border px-3 py-2 text-sm text-[#0f172a] shadow-sm transition-colors focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-[#b91c1c]',
        hasError
